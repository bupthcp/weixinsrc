...
public class FriendGroup extends BaseProtoBuf
{
    ...
    {
        if(!c)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  GroupId:").append(c).append("").toString());
        else
            return super.b();
    }
