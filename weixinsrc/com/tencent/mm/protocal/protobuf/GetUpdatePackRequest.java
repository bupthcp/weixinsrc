...
public class GetUpdatePackRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetUpdatePackRequest()
    {
    }
    ...
    {
        if(!c || !e || !g || !i)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseRequest:").append(c).append(" UpdateType:").append(e).append(" TotalLen:").append(g).append(" StartPos:").append(i).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        String s2 = (new StringBuilder()).append(s1).append("UpdateType = ").append(d).append("   ").toString();
