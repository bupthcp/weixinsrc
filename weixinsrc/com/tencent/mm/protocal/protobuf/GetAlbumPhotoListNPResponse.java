...
public class GetAlbumPhotoListNPResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public GetAlbumPhotoListNPResponse()
    {
        f = new LinkedList();
    }

    public static GetAlbumPhotoListNPResponse a(byte abyte0[])
    {
        a a1;
        int i;
        GetAlbumPhotoListNPResponse getalbumphotolistnpresponse;
        a1 = new a(abyte0, a);
        i = a(a1);
        getalbumphotolistnpresponse = new GetAlbumPhotoListNPResponse();
_L6:
        if(i <= 0)
...
_L5:
        ...
        for(int k = 0; k < linkedlist1.size(); k++)
        {
            ...
            getalbumphotolistnpresponse.b = baseresponse;
            getalbumphotolistnpresponse.c = true;
        }

        flag = true;
          goto _L7
_L3:
        getalbumphotolistnpresponse.d = a1.a();
