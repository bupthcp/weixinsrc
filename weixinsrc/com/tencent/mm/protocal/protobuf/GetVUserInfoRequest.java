...
public class GetVUserInfoRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetVUserInfoRequest()
    {
    }
    ...
    {
        if(!c || !e)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseRequest:").append(c).append(" Version:").append(e).append("").toString());
        else
            return super.b();
    }
