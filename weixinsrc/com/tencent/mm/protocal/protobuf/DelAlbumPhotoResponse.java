...
public class DelAlbumPhotoResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public DelAlbumPhotoResponse()
    {
        f = new LinkedList();
    }

    public static DelAlbumPhotoResponse a(byte abyte0[])
    {
        a a1;
        int i;
        DelAlbumPhotoResponse delalbumphotoresponse;
        a1 = new a(abyte0, a);
        i = a(a1);
        delalbumphotoresponse = new DelAlbumPhotoResponse();
_L6:
        if(i <= 0)
...
_L5:
        ...
        for(int k = 0; k < linkedlist1.size(); k++)
        {
            ...
            delalbumphotoresponse.b = baseresponse;
            delalbumphotoresponse.c = true;
        }

        flag = true;
          goto _L7
_L3:
        delalbumphotoresponse.d = a1.a();
        delalbumphotoresponse.e = true;
        flag = true;
          goto _L7
        ...
        for(int j = 0; j < linkedlist.size(); j++)
        {
            ...
            if(!delalbumphotoresponse.g)
                delalbumphotoresponse.g = true;
            delalbumphotoresponse.f.add(albumphotoid);
        }

        flag = true;
          goto _L7
        return delalbumphotoresponse.d();
    }

    private DelAlbumPhotoResponse d()
    {
        if(!c || !e)
    ...
    public String toString()
    {
        ...
        String s3 = (new StringBuilder()).append(s2).append("IDList = ").append(f).append("   ").toString();
