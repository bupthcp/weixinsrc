...
public class SyncFriendResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public SyncFriendResponse()
    {
        j = new LinkedList();
    }
    ...
    public final int a()
    {
        return 0 + c.a.a.a.a(2, d) + c.a.a.a.a(3, f) + c.a.a.a.a(4, h) + (0 + c.a.a.a.b(1, b.a()) + c.a.a.a.a(5, 8, j));
    }
    ...
    {
        if(!c || !e || !g || !i)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseResponse:").append(c).append(" NewSyncKey:").append(e).append(" ContinueFlag:").append(g).append(" CmdCount:").append(i).append("").toString());
        else
            return super.b();
    }
