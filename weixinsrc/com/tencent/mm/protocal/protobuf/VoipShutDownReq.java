...
public class VoipShutDownReq extends BaseProtoBuf
    implements RequestProtoBuf
{

    public VoipShutDownReq()
    {
    }
    ...
    public final VoipShutDownReq a(int i)
    {
        f = i;
        g = true;
        return this;
    ...
    public final VoipShutDownReq a(BaseRequest baserequest)
    {
        b = baserequest;
        c = true;
        return this;
