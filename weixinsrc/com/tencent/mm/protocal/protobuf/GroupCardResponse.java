...
public class GroupCardResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public GroupCardResponse()
    {
    }
    ...
    public String toString()
    {
        ...
        if(e)
            s1 = (new StringBuilder()).append(s1).append("GroupUserName = ").append(d).append("   ").toString();
