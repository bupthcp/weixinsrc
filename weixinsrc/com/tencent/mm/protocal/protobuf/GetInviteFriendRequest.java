...
public class GetInviteFriendRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetInviteFriendRequest()
    {
    }
    ...
    public String toString()
    {
        ...
        if(e)
            s1 = (new StringBuilder()).append(s1).append("FriendType = ").append(d).append("   ").toString();
