...
public class BatchGetContactProfileResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public BatchGetContactProfileResponse()
    {
        f = new LinkedList();
    }
    ...
    public String toString()
    {
        ...
        String s3 = (new StringBuilder()).append(s2).append("ContactProfileBufList = ").append(f).append("   ").toString();
