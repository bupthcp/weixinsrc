...
public class QuitChatRoom extends BaseProtoBuf
{
    ...
    {
        if(!c || !e)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  ChatRoomName:").append(c).append(" UserName:").append(e).append("").toString());
        else
            return super.b();
    }
