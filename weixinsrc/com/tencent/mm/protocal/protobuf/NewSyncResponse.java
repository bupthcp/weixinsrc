...
public class NewSyncResponse extends BaseProtoBuf
{
    ...
    {
        if(!c || !e || !g || !i)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  Ret:").append(c).append(" CmdList:").append(e).append(" ContinueFlag:").append(g).append(" KeyBuf:").append(i).append("").toString());
        else
            return super.b();
    }
