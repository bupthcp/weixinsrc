...
public class ShakeImgResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public ShakeImgResponse()
    {
    }
    ...
    {
        if(!c || !e || !g || !i || !k)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseResponse:").append(c).append(" ImgId:").append(e).append(" TotalLen:").append(g).append(" StartPos:").append(i).append(" Buffer:").append(k).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        String s5 = (new StringBuilder()).append(s4).append("Buffer = ").append(j).append("   ").toString();
