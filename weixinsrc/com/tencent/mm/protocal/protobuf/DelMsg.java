...
public class DelMsg extends BaseProtoBuf
{
    ...
    {
        if(!c || !e)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  UserName:").append(c).append(" Count:").append(e).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        String s3 = (new StringBuilder()).append(s2).append("MsgIdList = ").append(f).append("   ").toString();
