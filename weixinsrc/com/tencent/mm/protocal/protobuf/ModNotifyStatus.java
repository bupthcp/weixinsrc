...
public class ModNotifyStatus extends BaseProtoBuf
{

    public ModNotifyStatus()
    {
    }
    ...
    {
        if(!c || !e)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  UserName:").append(c).append(" Status:").append(e).append("").toString());
        else
            return super.b();
    }
