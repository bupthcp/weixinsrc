...
public class GetTLPhotoListFPRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetTLPhotoListFPRequest()
    {
    }
    ...
    public final GetTLPhotoListFPRequest a(BaseRequest baserequest)
    {
        b = baserequest;
        c = true;
        return this;
    ...
    public final GetTLPhotoListFPRequest a(String s)
    {
        d = s;
        e = true;
        return this;
