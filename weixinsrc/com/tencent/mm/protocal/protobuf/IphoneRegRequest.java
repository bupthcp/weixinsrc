...
public class IphoneRegRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public IphoneRegRequest()
    {
    }
    ...
    public String toString()
    {
        ...
        if(e)
            s1 = (new StringBuilder()).append(s1).append("Token = ").append(d).append("   ").toString();
        if(g)
            s1 = (new StringBuilder()).append(s1).append("Sound = ").append(f).append("   ").toString();
        if(i)
            s1 = (new StringBuilder()).append(s1).append("Status = ").append(h).append("   ").toString();
        if(k)
            s1 = (new StringBuilder()).append(s1).append("VoipSound = ").append(j).append("   ").toString();
