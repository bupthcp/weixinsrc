...
public class BatchGetHeadImgResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public BatchGetHeadImgResponse()
    {
        f = new LinkedList();
    }
    ...
    public String toString()
    {
        ...
        String s3 = (new StringBuilder()).append(s2).append("ImgPairList = ").append(f).append("   ").toString();
