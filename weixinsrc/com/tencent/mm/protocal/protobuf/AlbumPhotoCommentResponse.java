...
public class AlbumPhotoCommentResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public AlbumPhotoCommentResponse()
    {
    }

    public static AlbumPhotoCommentResponse a(byte abyte0[])
    {
        a a1;
        int i;
        AlbumPhotoCommentResponse albumphotocommentresponse;
        a1 = new a(abyte0, a);
        i = a(a1);
        albumphotocommentresponse = new AlbumPhotoCommentResponse();
_L7:
...
_L4:
        ...
        for(int j = 0; j < linkedlist.size(); j++)
        {
            ...
            albumphotocommentresponse.b = baseresponse;
            albumphotocommentresponse.c = true;
        }

        flag = true;
        if(true) goto _L5; else goto _L2
_L2:
        return albumphotocommentresponse.d();
        if(true) goto _L7; else goto _L6
_L6:
    }

    private AlbumPhotoCommentResponse d()
    {
        if(!c)
