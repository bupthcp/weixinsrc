...
public class GetHDHeadImgResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public GetHDHeadImgResponse()
    {
    }
    ...
    public final int a()
    {
        ...
        return l + c.a.a.a.a(3, f) + c.a.a.a.a(4, h) + (0 + c.a.a.a.b(1, b.a()) + c.a.a.a.b(5, j.a()));
    }
    ...
    {
        if(!c || !g || !i || !k)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseResponse:").append(c).append(" TotalLen:").append(g).append(" StartPos:").append(i).append(" Data:").append(k).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        String s4 = (new StringBuilder()).append(s3).append("Data = ").append(j).append("   ").toString();
