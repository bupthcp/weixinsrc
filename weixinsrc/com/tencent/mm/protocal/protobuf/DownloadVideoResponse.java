...
public class DownloadVideoResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{
    ...
    {
        if(!c || !e || !g || !i || !k)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseResponse:").append(c).append(" MsgId:").append(e).append(" TotalLen:").append(g).append(" StartPos:").append(i).append(" Data:").append(k).append("").toString());
        else
            return super.b();
    }
