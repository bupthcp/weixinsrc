...
public class GetAlbumPhotoListFPResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public GetAlbumPhotoListFPResponse()
    {
        h = new LinkedList();
    }

    public static GetAlbumPhotoListFPResponse a(byte abyte0[])
    {
        a a1;
        int j;
        GetAlbumPhotoListFPResponse getalbumphotolistfpresponse;
        a1 = new a(abyte0, a);
        j = a(a1);
        getalbumphotolistfpresponse = new GetAlbumPhotoListFPResponse();
_L7:
        if(j <= 0)
...
_L6:
        ...
        for(int l = 0; l < linkedlist1.size(); l++)
        {
            ...
            getalbumphotolistfpresponse.b = baseresponse;
            getalbumphotolistfpresponse.c = true;
        }

        flag = true;
          goto _L8
_L3:
        getalbumphotolistfpresponse.d = a1.b();
        getalbumphotolistfpresponse.e = true;
        flag = true;
          goto _L8
_L4:
        getalbumphotolistfpresponse.f = a1.a();
        getalbumphotolistfpresponse.g = true;
        flag = true;
          goto _L8
        ...
        for(int k = 0; k < linkedlist.size(); k++)
        {
            ...
            if(!getalbumphotolistfpresponse.i)
                getalbumphotolistfpresponse.i = true;
            getalbumphotolistfpresponse.h.add(albumphotodata);
        }

        flag = true;
          goto _L8
        return getalbumphotolistfpresponse.g();
    }

    private GetAlbumPhotoListFPResponse g()
    {
        if(!c || !g)
