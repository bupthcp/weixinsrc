...
//            ResponseProtoBuf, BaseResponse, AlbumPhoto

public class BatchGetAlbumPhotoResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public BatchGetAlbumPhotoResponse()
    {
        f = new LinkedList();
    }

    public static BatchGetAlbumPhotoResponse a(byte abyte0[])
    {
        a a1;
        int i;
        BatchGetAlbumPhotoResponse batchgetalbumphotoresponse;
        a1 = new a(abyte0, a);
        i = a(a1);
        batchgetalbumphotoresponse = new BatchGetAlbumPhotoResponse();
_L6:
        if(i <= 0)
...
_L5:
        ...
        for(int k = 0; k < linkedlist1.size(); k++)
        {
            ...
            batchgetalbumphotoresponse.b = baseresponse;
            batchgetalbumphotoresponse.c = true;
        }

        flag = true;
          goto _L7
_L3:
        batchgetalbumphotoresponse.d = a1.a();
        batchgetalbumphotoresponse.e = true;
        flag = true;
          goto _L7
        ...
        for(int j = 0; j < linkedlist.size(); j++)
        {
            ...
            a a2 = new a(abyte1, a);
            for(boolean flag1 = true; flag1; flag1 = com.tencent.mm.protocal.protobuf.AlbumPhoto.a(a2, albumphoto, a(a2)));
            if(!batchgetalbumphotoresponse.g)
                batchgetalbumphotoresponse.g = true;
            batchgetalbumphotoresponse.f.add(albumphoto);
        }

        flag = true;
          goto _L7
        return batchgetalbumphotoresponse.e();
    }

    private BatchGetAlbumPhotoResponse e()
    {
        if(!c || !e)
