...
public class VoipShutDownResp extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public VoipShutDownResp()
    {
    }

    public static VoipShutDownResp a(byte abyte0[])
    {
        a a1;
        int i;
        ...
        a1 = new a(abyte0, a);
        i = a(a1);
        voipshutdownresp = new VoipShutDownResp();
_L7:
...
_L4:
        ...
        for(int j = 0; j < linkedlist.size(); j++)
        {
            ...
            voipshutdownresp.b = baseresponse;
            voipshutdownresp.c = true;
        }

        flag = true;
        if(true) goto _L5; else goto _L2
_L2:
        return voipshutdownresp.d();
        if(true) goto _L7; else goto _L6
_L6:
    }

    private VoipShutDownResp d()
    {
        if(!c)
