...
public class GetMailOAuthUrlResponse extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public GetMailOAuthUrlResponse()
    {
    }
    ...
    public String toString()
    {
        ...
        if(e)
            s1 = (new StringBuilder()).append(s1).append("OAuthUrl = ").append(d).append("   ").toString();
