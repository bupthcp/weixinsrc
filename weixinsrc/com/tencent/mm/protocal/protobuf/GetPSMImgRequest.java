...
public class GetPSMImgRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetPSMImgRequest()
    {
    }
    ...
    {
        if(!c || !g)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseRequest:").append(c).append(" Offset:").append(g).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        if(e)
            s1 = (new StringBuilder()).append(s1).append("URL = ").append(d).append("   ").toString();
