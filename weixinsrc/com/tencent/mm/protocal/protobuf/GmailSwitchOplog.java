...
public class GmailSwitchOplog extends BaseProtoBuf
{

    public GmailSwitchOplog()
    {
    }
    ...
    {
        if(!e)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  GmailSwitch:").append(e).append("").toString());
        else
            return super.b();
    }
