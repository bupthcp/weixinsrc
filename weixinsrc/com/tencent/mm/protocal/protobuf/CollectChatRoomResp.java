...
public class CollectChatRoomResp extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public CollectChatRoomResp()
    {
    }

    public static CollectChatRoomResp a(byte abyte0[])
    {
        a a1;
        int i;
        ...
        a1 = new a(abyte0, a);
        i = a(a1);
        collectchatroomresp = new CollectChatRoomResp();
_L7:
...
_L4:
        ...
        for(int j = 0; j < linkedlist.size(); j++)
        {
            ...
            collectchatroomresp.b = baseresponse;
            collectchatroomresp.c = true;
        }

        flag = true;
        if(true) goto _L5; else goto _L2
_L2:
        return collectchatroomresp.d();
        if(true) goto _L7; else goto _L6
_L6:
    }

    private CollectChatRoomResp d()
    {
        if(!c)
