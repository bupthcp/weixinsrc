...
public class GetMailOAuthUrlRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetMailOAuthUrlRequest()
    {
    }
    ...
    public String toString()
    {
        ...
        if(e)
            s1 = (new StringBuilder()).append(s1).append("MailAccount = ").append(d).append("   ").toString();
