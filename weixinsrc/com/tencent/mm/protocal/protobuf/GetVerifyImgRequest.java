...
public class GetVerifyImgRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public GetVerifyImgRequest()
    {
    }
    ...
    {
        if(!c || !e || !g)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseRequest:").append(c).append(" UserName:").append(e).append(" Pwd:").append(g).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        String s3 = (new StringBuilder()).append(s2).append("Pwd = ").append(f).append("   ").toString();
