...
public class DownloadVideoRequest extends BaseProtoBuf
    implements RequestProtoBuf
{
    ...
    public final int a()
    {
        int l = 0 + c.a.a.a.a(2, d) + c.a.a.a.a(3, f) + c.a.a.a.a(4, h);
        if(k)
            l += c.a.a.a.a(5, j);
    ...
    {
        if(!c || !e || !g || !i)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseRequest:").append(c).append(" MsgId:").append(e).append(" TotalLen:").append(g).append(" StartPos:").append(i).append("").toString());
        else
            return super.b();
    }
    ...
    public String toString()
    {
        ...
        if(k)
            s4 = (new StringBuilder()).append(s4).append("NetworkEnv = ").append(j).append("   ").toString();
