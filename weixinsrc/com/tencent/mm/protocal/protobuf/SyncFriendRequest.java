...
public class SyncFriendRequest extends BaseProtoBuf
    implements RequestProtoBuf
{

    public SyncFriendRequest()
    {
    }

    public final int a()
    {
        return 0 + c.a.a.a.a(3, f) + c.a.a.a.a(4, h) + (0 + c.a.a.a.b(1, b.a()) + c.a.a.a.b(2, d.a()));
    }
    ...
    {
        if(!c || !e || !g || !i)
            throw new c((new StringBuilder()).append("Not all required fields were included (false = not included in message),  BaseRequest:").append(c).append(" UserName:").append(e).append(" SyncKey:").append(g).append(" Scene:").append(i).append("").toString());
        else
            return super.b();
    }
