...
public class VoipCancelInviteResp extends BaseProtoBuf
    implements ResponseProtoBuf
{

    public VoipCancelInviteResp()
    {
    }

    public static VoipCancelInviteResp a(byte abyte0[])
    {
        a a1;
        int i;
        ...
        a1 = new a(abyte0, a);
        i = a(a1);
        voipcancelinviteresp = new VoipCancelInviteResp();
_L7:
...
_L4:
        ...
        for(int j = 0; j < linkedlist.size(); j++)
        {
            ...
            voipcancelinviteresp.b = baseresponse;
            voipcancelinviteresp.c = true;
        }

        flag = true;
        if(true) goto _L5; else goto _L2
_L2:
        return voipcancelinviteresp.d();
        if(true) goto _L7; else goto _L6
_L6:
    }

    private VoipCancelInviteResp d()
    {
        if(!c)
