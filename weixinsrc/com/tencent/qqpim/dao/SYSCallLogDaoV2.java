...
public class SYSCallLogDaoV2 extends SYSCallLogDao
{
    ...
    private SYSCallLogDaoV2(Context context1)
    {
        super(context1);
...
_L7:
    ...
    protected static SYSCallLogDaoV2 getInstance(Context context1)
    {
        return new SYSCallLogDaoV2(context1);
    }
...
_L2:
        ...
        long l1;
        String s;
        builder = ContentProviderOperation.newInsert(android.provider.CallLog.Calls.CONTENT_URI).withYieldAllowed(true);
        flag1 = false;
        flag2 = false;
        l = 0L;
        l1 = 0L;
...
label0:
        {
            if(!ientity.isAfterLast())
                break label0;
            if(!flag1)
                builder.withValue("number", "-1");
            if(!flag2 && l != 0L && l1 != 0L && l < l1)
                builder.withValue("duration", Long.valueOf((l1 - l) / 1000L));
            flag = arraylist.add(builder.build());
        }
        if(true) goto _L4; else goto _L3
_L3:
        Record record = ientity.getCurrentValue();
        if(record == null) goto _L6; else goto _L5
_L5:
        String s1;
        long l2;
        boolean flag3;
        ...
        if(record.get(0).equals("N"))
        {
            if(htcRawContactIDColumnExist)
            {
                ...
                {
                    String s3 = iphonelookup1.lookupFirstContactIDByPhone(s);
                    if(s3 != null && s3.length() > 0)
                        builder.withValue(HTC_EXTENDED_COLUMN_NAME, s3);
                }
            }
            ...
            if(iphonelookup != null)
                s2 = iphonelookup.lookupFirstContactNameByPhone(s);
            else
                s2 = null;
            if(s2 == null || s2.length() == 0)
                s2 = record.get(2);
            builder.withValue("name", s2);
            s1 = s;
            l2 = l;
            flag3 = flag1;
        } else
        {
            if(record.get(0).equals("STARTTIME"))
            {
                ...
                builder.withValue("date", Long.valueOf(l));
            }
            s1 = s;
            l2 = l;
            flag3 = flag1;
        ...
        {
            builder.withValue("duration", record.get(2));
            l4 = l1;
            flag4 = true;
            l3 = l4;
        } else
...
label1:
        ...
        if(record.get(2).equals("MISS"))
            builder.withValue("type", Integer.valueOf(3));
        l3 = l1;
        flag4 = flag2;
...
_L1:
        ContentProviderResult acontentproviderresult[] = contentResolver.applyBatch("call_log", arraylist2);
        int k = 0;
_L7:
...
_L8:
    ...
    private class Model extends Enum
    {
        ...
        {
            return (Model)Enum.valueOf(com/tencent/qqpim/dao/SYSCallLogDaoV2$Model, s);
        }
