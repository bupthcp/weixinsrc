...
public class SyncmlEngine
{
    ...
    public SyncmlEngine()
    {
        cppInstance = newSyncmlEngineInstance();
        if(cppInstance == 0)
    ...
    private native byte[] asyncNext(int i);

    private native byte[] asyncStart(int i);

    private native void deleteSyncmlEngineObject(int i);
    ...
    {
        return asyncNext(cppInstance);
    }

    public byte[] asyncStart()
    {
        return asyncStart(cppInstance);
    }
    ...
    public void end()
    {
        ...
        if(cppInstance != 0)
        {
            deleteSyncmlEngineObject(cppInstance);
            cppInstance = 0;
        }
    }
    ...
    private class SyncType extends Enum
    {
        ...
        {
            return (SyncType)Enum.valueOf(com/tencent/tccsync/SyncmlEngine$SyncType, s);
        }
